...
exit;
  ...
  echo -e 'by: @QSS_NET' >/usr/lib/telegram
  msg -bar
...
wget https://github.com/ricardoqss/pweb/raw/painel/install/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://github.com/ricardoqss/pweb/raw/painel/install/verifatt.sh > /dev/null 2>&1
wget https://github.com/ricardoqss/pweb/raw/painel/install/verpweb > /dev/null 2>&1
wget https://github.com/ricardoqss/pweb/raw/painel/install/verweb > /dev/null 2>&1
...
wget https://github.com/ricardoqss/pweb/raw/painel/install/gestorssh.zip > /dev/null 2>&1
...
echo -e "                              \033[1;31mBy @QSS NET\033[1;36m"
echo ""
...
echo -e "                              \033[1;31mBy @QSS_NETslayer\033[1;36m"
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@QSS_NETslayer\033[0m"
echo ""
